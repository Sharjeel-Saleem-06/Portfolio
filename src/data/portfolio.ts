export const personalInfo = {
  ...
  bio: "I'm M. Sharjeel Saleem, a passionate Full-Stack AI Prompt Engineer who bridges the gap between cutting-edge artificial intelligence and practical software solutions. With over 2 years of experience in AI-driven development, I specialize in creating intelligent applications that transform complex problems into elegant, user-friendly experiences. Currently at Sideline Technologies, I leverage advanced AI tools like Cursor AI, Claude Code, and Trae AI to accelerate development workflows and build next-generation applications. My expertise spans from developing YOLOv8-powered computer vision systems for traffic management to creating AI-integrated communication platforms that revolutionize how businesses interact with their clients. I believe in the power of AI to enhance human creativity and productivity, and I'm dedicated to crafting solutions that are not just functional, but truly intelligent.",
